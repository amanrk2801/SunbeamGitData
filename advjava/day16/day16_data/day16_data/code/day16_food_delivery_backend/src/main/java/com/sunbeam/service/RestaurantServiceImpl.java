...
public class RestaurantServiceImpl implements RestaurantService {
	...
	public RestaurantDTO getRestaurantDetails(Long id) {
		// invoke dao's method - findById
		 ...
		 /*
		  * API of ModelMapper
		  * public <D> D map(Object src, Class<D> destinationClass);
		  * 1. create dest class instance - using def constructor
		  * 2. calls getter on src  -> calls MATCHING setter on dest obj		  * 
		  */
	...
	public RestaurantMenuDTO getCompleteDetails(Long restaurantId) {
		...
		Restaurant entity=
		restaurantDao.getRestaurantAndMenu(restaurantId)
		.orElseThrow(() ->
		new ResourceNotFoundException("Restaurant not found - invalid id !!!!"));
		//2. entity -> dto
